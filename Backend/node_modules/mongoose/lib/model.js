...
const { createTracedChannel } = require('mongoose/lib/tracing');
...
const convertErrorToStandardSchemaIssues = require('mongoose/lib/standardSchema/convertErrorToIssues');
...
const splitPopulateQuery = require('mongoose/lib/helpers/populate/splitPopulateQuery');
