    ...
    if (loading) {
        return (
            <main className='loading-screen'>
                <h1>{loadingMessage || 'Loading your interview plan...'}</h1>
            </main>
        )
    }
                        ...
                        <div className='upload-section'>
                            ...
                            {selectedFile ? (
                                <div className='dropzone dropzone--selected'>
                                    ...
                                    <p className='dropzone__title dropzone__title--file-name'>{selectedFile.name}</p>
                                    <p className='dropzone__subtitle'>{(selectedFile.size / (1024 * 1024)).toFixed(2)} MB &bull; Ready</p>
                                    <button 
                                        type='button' 
